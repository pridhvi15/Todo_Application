...
from task_manager.views import Home,Userregister,Account_login,TaskAddView,TaskReadView,TaskDeleteView,TaskDetailsView,TaskUpdateView,Signout,Task_complete
...
urlpatterns = [
    ...
    path('task_manager/delete/<int:pk>',TaskDeleteView.as_view()),
    path('task_manager/details/<int:pk>',TaskDetailsView.as_view()),
